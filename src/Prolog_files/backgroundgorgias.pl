...
rule(bg10, malwareLinkedTo('Backdoor.Duuzer','lazarusGrp'), []).
rule(bg11, malwareLinkedTo('Backdoor.Destover','lazarusGrp'), []).
rule(bg12, malwareLinkedTo('infostealerFakepude','lazarusGrp'), []).
rule(bg13, malwareLinkedTo('Backdoor.Contopee','lazarusGrp'), []).
